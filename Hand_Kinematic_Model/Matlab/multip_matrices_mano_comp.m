...
% T(0-1)
syms qic Lime; Q1=qic; d1=0; a1=Lime; af1=(-90);
...
% T(1-2)
syms qima; Q2=qima; d2=0; a2=0; af2=90;
...
% T(2-3)
syms qimf Lip; Q3=qimf; d3=0; a3=Lip; af3=0;
...
% T(3-4)
syms qip Limi; Q4=qip; d4=0; a4=Limi; af4=0;
...
% T(4-5)
syms qid Lid; Q5=qid; d5=0; a5=Lid; af5=0;
...
% Tp(0-1)
syms qpta; Qp1=qpta; dp1=0; ap1=0; afp1=(90);
...
% Tp(1-2)
syms qptf Ltm; Qp2=qptf; dp2=0; ap2=Ltm; afp2=0;
...
Tp12=[cos(Qp2) -sin(Qp2)*cosd(afp2) sin(Qp2)*sind(afp2) ap2*cos(Qp2); 
 ...
 % Tp(2-3)
syms qpm Ltp; Qp3=qpm; dp3=0; ap3=Ltp; afp3=0;
...
Tp23=[cos(Qp3) -sin(Qp3)*cosd(afp3) sin(Qp3)*sind(afp3) ap3*cos(Qp3); 
 ...
 % Tp(3-4)
syms qpi Ltd; Qp4=qpi; dp4=0; ap4=Ltd; afp4=0;
